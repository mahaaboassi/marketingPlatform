        ...
        <div className={`${Style.header} flex justify-between items-center`}>
            ...
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" viewBox="0 0 24 21" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0 10.1173L4.42969 10.0599C6.14062 11.0261 7.67188 12.2774 8.99023 13.8597C12.4004 8.32079 16.3184 3.78253 20.625 0H24C17.9785 6.55293 13.0645 13.5689 9.13477 21C7.0332 16.5861 4.09375 12.8705 0 10.1173Z" fill="#01A601"/>
                </svg>
            </div>
        </div>
